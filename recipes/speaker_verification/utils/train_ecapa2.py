...
def main() -> None:
    ...
    optimizer = torch.optim.SGD(
        [
            {
                "params": ecapa2_model.module.preecapa2.parameters(),
                "weight_decay": 0.0001,
                "lr": 0.00001,
            },
            {
                "params": ecapa2_model.module.temporal_pooling.parameters(),
                "weight_decay": 0.0001,
                "lr": 0.00001,
            },
            {
                "params": ecapa2_model.module.embedding.parameters(),
                "weight_decay": 0.0001,
                "lr": 0.00001,
            },
            {"params": ecapa2_model.module.output.parameters(), "lr": 0.00001},
        ],
        momentum=0.9,
    )
