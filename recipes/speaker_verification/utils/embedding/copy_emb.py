...
def main():
    ...
    parser.add_argument("input_spec", help="Input spec (e.g., 'pkl:file.pkl', 'pkl:-', 'pkl,t:file.txt', 'pkl:python normalize.py ... |')")
    parser.add_argument("output_spec", help="Output spec (e.g., 'pkl:file.pkl', 'pkl:-', 'pkl,t:file.txt', 'pkl,t:-')")
