...
def prepare_cfad(in_data: Pathlike = ".", out_data: Pathlike = ".", num_jobs: int = 20):
    ...
    wav_lst1 = get_all_files(in_data / "codec_version" / "test_seen_codec" , match_and=[".wav"])
    wav_lst2 = get_all_files(in_data / "codec_version" / "test_unseen_codec" , match_and=[".wav"])
