...
def process_file(segment: Pathlike, in_data: Pathlike, sampling_frequency: int, vad: bool):
...
def prepare_voxceleb2(sampling_frequency: int, canDeleteZIP: bool, in_data: Pathlike = ".", out_data: Pathlike = ".", vad: bool = False, num_jobs: int = 20):
...
def _process_file(file_path: Pathlike, output: Pathlike, sampling_frequency: int, vad: bool):
...
if __name__ == '__main__':
    ...
    prepare_voxceleb2(args.downsampling, args.deleteZIP, Path(args.in_data), Path(args.out_data), args.vad, 20)
