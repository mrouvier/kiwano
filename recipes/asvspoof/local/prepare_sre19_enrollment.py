...
def prepare_sre19_enrollment(in_data: Pathlike, out_data: Pathlike, jobs: int):
    ...
    model = {}
    with open(in_data / "docs" / "sre19_cts_challenge_enrollment.tsv", "r") as f:
        for line in f:
            line = line.rstrip()
            line = line.split("\t")
            model[ line[1] ] = line[0]
    ...
    with ProcessPoolExecutor(jobs) as ex:
        ...
        for future in tqdm(futures, desc="Processing SRE19 Enrollment"):
...
if __name__ == '__main__':
    ...
    prepare_sre19_enrollment(args.in_data, args.out_data, args.thread)
