...
from kiwano.augmentation import Augmentation, Noise, Codec, Filtering, Normal, OneOf, Compose, CMVN, Crop, SpecAugment, Reverb, MediaVorbis, MediaG722, MediaOpus, MediaMP3
...
class SpeakerTrainingSegmentSet(Dataset, SegmentSet):
    def __init__(self, audio_transforms: List[Augmentation] = None, codec_transforms: List[Augmentation] = None, feature_extractor = None, feature_transforms: List[Augmentation] = None):
        super().__init__()
        self.audio_transforms = audio_transforms
        self.feature_transforms = feature_transforms
        self.feature_extractor = feature_extractor
        self.codec_transforms = codec_transforms
    ...
    def __getitem__(self, segment_id_or_index: Union[int, str]) -> Segment:
        ...
        if self.codec_transforms != None:
            audio, sample_rate = self.codec_transforms(audio, sample_rate)
