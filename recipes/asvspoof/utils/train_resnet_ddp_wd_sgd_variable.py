...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(training_data, batch_size=64, drop_last=True, shuffle=False, num_workers=8, sampler=train_sampler, pin_memory=False, collate_fn=custom_collate_fn)
