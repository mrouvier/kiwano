...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(training_data, batch_size=16, drop_last=True, shuffle=False, num_workers=8, sampler=train_sampler, pin_memory=False)
    ...
    optimizer = torch.optim.Adam(resnet_model.parameters(), lr = 0.0001, weight_decay = 2e-5)
    if args.checkpoint:
    ...
    for epochs in range(epochs_start, 30):
        iterations = 0
