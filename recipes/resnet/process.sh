...
#python3 local/prepare_nist.py --in_data /users/rouvier/spkdiarization/sre19/v4/db/nist-sre-train2008 --out_data db/nist/nist-sre-train2008
#python3 local/prepare_nist.py --in_data /users/rouvier/spkdiarization/sre19/v4/db/nist-sre-test2008 --out_data db/nist/nist-sre-test2008

#python3 local/prepare_nist.py  --in_data db/nist/nist-sre-train2008  --out_data db/nist/nist-sre-train2008/wav1
#python3 local/prepare_nist.py  --in_data db/nist/nist-sre-test2008  --out_data db/nist/nist-sre-test2008/wav1

python3 local/prepare_nist.py --deleteZIP --in_data db/nist/nist-sre-test2008/wav1 --out_data db/nist/nist-sre-test2008/wav
python3 local/prepare_nist.py --deleteZIP --in_data db/nist/nist-sre-train2008/wav1 --out_data db/nist/nist-sre-train2008/wav

#rm -r db/nist/nist-sre-test2008/wav1
#rm -r db/nist/nist-sre-train2008/wav1
