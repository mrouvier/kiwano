...
python3 utils/train_ecapa_tdnn.py --save_path exps/exp_wavlm_base_ddp --feat_type wavlm --n_cpu 16 --batch_size 512 --model_name microsoft/wavlm-base --max_epoch 100
