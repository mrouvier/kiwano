...
VOXCELEB2_PARTS_URL = [
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partaa",
        "da070494c573e5c0564b1d11c3b20577",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partab",
        "17fe6dab2b32b48abaf1676429cdd06f",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partac",
        "1de58e086c5edf63625af1cb6d831528",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partad",
        "5a043eb03e15c5a918ee6a52aad477f9",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partae",
        "cea401b624983e2d0b2a87fb5d59aa60",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partaf",
        "fc886d9ba90ab88e7880ee98effd6ae9",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partag",
        "d160ecc3f6ee3eed54d55349531cb42e",
    ],
    [
        "http://drbenchmark.univ-avignon.fr/corpus/voxceleb2/vox1a/vox2_dev_aac_partah",
...
VOXCELEB2_META_URL = [
    [
        "https://www.openslr.org/resources/49/vox2_meta.csv",
        "6090d767f8334733dfe4c6578fa725c2",
    ]
]
        ...
        for url in VOXCELEB2_PARTS_URL:
            ...
            if not fname.exists() and not force_download:
                urlretrieve_progress(
                    ...
                    desc=f"Downloading VoxCeleb2 {url[0].split('/')[-1]}",
                )
...
if __name__ == "__main__":
    ...
    download_voxceleb2(
        args.target_dir, args.force_download, args.check_md5, args.thread
    )
